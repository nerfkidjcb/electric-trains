...
local electric_train_back_light_color = {r = 0.8, g = 0.25, b = 0.8, a = 0.25}
local space
train_scale = 0.425
    ...
    return {
        layers = {
            space_accumulator_picture({r = 1, g = 1, b = 1, a = 1}, 30), {
                filenames = {
                    "__electric-trains__/graphics/entity/electric-train-charging-station/hr_space_charging_station_lightning.png"
                },
                priority = "high",
                width = 128,
                height = 192,
...
function experimental_space_accumulator_charge()
    return {
        layers = {
            experimental_space_accumulator_picture({r = 1, g = 1, b = 1, a = 1},
                                                   30), {
...
space_train_wheels = {
    ...
    direction_count = 256,
    filenames = {
        "__electric-trains__/graphics/entity/vehicles/space-trains/maglev_cushions_1.png",
    ...
    rotated = {
        ...
        direction_count = 256,
        filenames = {
            "__electric-trains__/graphics/entity/vehicles/space-trains/hr_maglev_cushions_1.png",
...
data:extend({ -- Battery charging interface
    ...
    }, -- Actual Trains now
    {
        ...
        resistances = {
            {type = "fire", decrease = 20, percent = 75},
                ...
                layers = {
                    {
                        ...
                        filenames = {
                            "__electric-trains__/graphics/entity/vehicles/space-trains/hr_space_locomotive_1.png",
                        ...
                        direction_count = 256,
                        filenames = {
                            "__electric-trains__/graphics/entity/vehicles/space-trains/hr_space_locomotive_mask_1.png",
                        ...
                        draw_as_shadow = true,
                        filenames = {
                            "__electric-trains__/graphics/entity/vehicles/space-trains/hr_space_locomotive_shadows_1.png",
                ...
                layers = {
                    {
                        ...
                        allow_low_quality_rotation = true,
                        filenames = {
                            "__electric-trains__/graphics/entity/vehicles/space-trains/hr_space_locomotive_lights_front_1.png",
        ...
        stop_trigger = { -- left side
            ...
            }, {type = "play-sound", sound = sounds.train_brakes}
        },
        ...
        icon_size = 64,
        flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
        minable = {mining_time = 1, result = "electric-locomotive-wagon"},
        mined_sound = sounds.deconstruct_large(0.8),
        max_health = 1500,
        deliver_category = "vehicle",
                ...
                layers = {
                    {
                        ...
                        allow_low_quality_rotation = true,
                        filenames = {
                            "__electric-trains__/graphics/entity/vehicles/space-trains/electric-locomotive-wagon/hr_electric_locomotive_wagon_1.png",
                        ...
                        allow_low_quality_rotation = true,
                        filenames = {
                            "__electric-trains__/graphics/entity/vehicles/space-trains/electric-locomotive-wagon/hr_electric_locomotive_wagon_mask_1.png",
                        ...
                        allow_low_quality_rotation = true,
                        filenames = {
                            "__electric-trains__/graphics/entity/vehicles/space-trains/electric-locomotive-wagon/hr_electric_locomotive_wagon_shadows_1.png",
        ...
        flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
        inventory_size = 50,
        minable = {mining_time = 0.5, result = "electric-cargo-wagon"},
        mined_sound = {
        ...
        icon_mipmaps = 4,
        flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
        minable = {mining_time = 0.5, result = "electric-fluid-wagon"},
        mined_sound = {
            filename = "__core__/sound/deconstruct-large.ogg",
            volume = 0.8
        },
                ...
                layers = {
                    {
                        ...
                        allow_low_quality_rotation = true,
                        filenames = {
                            "__electric-trains__/graphics/entity/vehicles/space-trains/hr_space_fluid_wagon_1.png",
                        ...
                        allow_low_quality_rotation = true,
                        filenames = {
                            "__electric-trains__/graphics/entity/vehicles/space-trains/hr_space_fluid_wagon_shadows_1.png",
