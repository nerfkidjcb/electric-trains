data:extend({
    {
        ...
        allowed_values = {
            "50.000 (Vanilla)", "60.000 (Default)", "150.000 (Extended)"
        }
    }, {
        type = "string-setting",
        ...
        allowed_values = {
            "40 Slots (Vanilla)", "50 Slots (Default)", "120 Slots (Extended)"
        }
    }, {
        type = "string-setting",
        ...
        allowed_values = {
            "238 km/h (Vanilla)", "378 km/h", "518 km/h (Default)",
            "714 km/h (Extended)"
        }
    }
})
