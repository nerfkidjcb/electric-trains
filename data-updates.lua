...
data:extend({
  ...
  elseif mods["space-age"] and settings.startup["lock-behind-fulgora"].value == "true" then
    ...
    data.raw["recipe"]["recipe-electric-locomotive"].ingredients = {{type="item", name="steel-plate", amount=40},{type="item", name="electric-engine-unit", amount=50},{type="item", name="advanced-circuit", amount=10}, {type="item", name="locomotive", amount=1}, {type="item", name="superconductor", amount=10}, {type="item", name="supercapacitor", amount=5}}
    ...
    data.raw["recipe"]["recipe-electric-locomotive-wagon"].ingredients = {{type="item", name="steel-plate", amount=40},{type="item", name="electric-engine-unit", amount=50},{type="item", name="advanced-circuit", amount=10}, {type="item", name="locomotive", amount=1}, {type="item", name="superconductor", amount=10}, {type="item", name="supercapacitor", amount=5}}
    ...
    data.raw["recipe"]["recipe-electric-cargo-wagon"].ingredients = {{type="item", name="steel-plate", amount=20},{type="item", name="electric-engine-unit", amount=5},{type="item", name="advanced-circuit", amount=10}, {type="item", name="cargo-wagon", amount=1}, {type="item", name="superconductor", amount=2}, {type="item", name="supercapacitor", amount=1}}
    ...
    data.raw["recipe"]["recipe-electric-fluid-wagon"].ingredients = {{type="item", name="steel-plate", amount=20},{type="item", name="electric-engine-unit", amount=5},{type="item", name="advanced-circuit", amount=10}, {type="item", name="fluid-wagon", amount=1}, {type="item", name="superconductor", amount=2}, {type="item", name="supercapacitor", amount=1}}
    ...
    data.raw["recipe"]["electric-train-battery-charging-station"].ingredients = {{type="item", name="processing-unit", amount=10},{type="item", name="steel-plate", amount=10},{type="item", name="superconductor", amount=5},{type="item", name="holmium-plate", amount=2}}
    ...
    data.raw["recipe"]["experimental-electric-train-battery-charging-station"].ingredients = {{type="item", name="processing-unit", amount=50},{type="item", name="steel-plate", amount=10},{type="item", name="superconductor", amount=10},{type="item", name="holmium-plate", amount=5}}
    -- normal powerpacks
    ...
    data.raw["recipe"]["electric-train-battery-pack"].ingredients = {{type="item", name="supercapacitor", amount=1},{type="item", name="superconductor", amount=2},{type="item", name="holmium-plate", amount=2}}
    -- alkaline powerpacks
    ...
    data.raw["recipe"]["recipe-electric-train-alkaline-battery-pack"].ingredients = {{type="item", name="supercapacitor", amount=1},{type="item", name="superconductor", amount=1},{type="item", name="holmium-plate", amount=2}}
    -- speed powerpacks
    ...
    data.raw["recipe"]["speed-battery-pack"].ingredients = {{type="item", name="supercapacitor", amount=2},{type="item", name="superconductor", amount=3},{type="item", name="holmium-plate", amount=5}, {type="item", name="speed-module", amount=1}}
    ...
    data.raw["recipe"]["acceleration-battery-pack"].ingredients = {{type="item", name="supercapacitor", amount=1},{type="item", name="superconductor", amount=4},{type="item", name="holmium-plate", amount=5}, {type="item", name="productivity-module", amount=1}}
    ...
    data.raw["recipe"]["efficiency-battery-pack"].ingredients = {{type="item", name="supercapacitor", amount=3},{type="item", name="superconductor", amount=2},{type="item", name="holmium-plate", amount=5}, {type="item", name="efficiency-module", amount=1}}
    
    -- ------------------------------ Update tech tree ------------------------------ --
    data.raw["technology"]["tech-electric-trains"].unit.ingredients = {}
    data.raw["technology"]["tech-electric-trains"].unit.ingredients = {{"automation-science-pack", 1}, {"logistic-science-pack", 1}, {"chemical-science-pack", 1}, {"production-science-pack", 1}, {"utility-science-pack", 1}, {"space-science-pack", 1}, {"electromagnetic-science-pack", 1}}
    data.raw["technology"]["tech-electric-trains"].unit.count = 2000
    data.raw["technology"]["tech-electric-trains"].prerequisites = {"processing-unit", "electromagnetic-plant", "railway", "holmium-processing", "electromagnetic-science-pack"}
    -- Update alkaline battery pack tech.
    -- Empty the ingredients table.
    data.raw["technology"]["tech-alkaline-battery-pack"].unit.ingredients = {}
    data.raw["technology"]["tech-alkaline-battery-pack"].unit.ingredients = {{"automation-science-pack", 1}, {"logistic-science-pack", 1}, {"chemical-science-pack", 1}, {"production-science-pack", 1}, {"utility-science-pack", 1}, {"space-science-pack", 1}, {"electromagnetic-science-pack", 1}}
    data.raw["technology"]["tech-alkaline-battery-pack"].unit.count = 2000
    -- Remove the old science prerequisites.
    data.raw["technology"]["tech-alkaline-battery-pack"].prerequisites = {}
    -- Add the new science prerequisites.
    ...
    -- Empty the ingredients table.
    data.raw["technology"]["tech-electric-trains-experimental-charging"].unit.ingredients = {}
    data.raw["technology"]["tech-electric-trains-experimental-charging"].unit.ingredients = {{"automation-science-pack", 1}, {"logistic-science-pack", 1}, {"chemical-science-pack", 1}, {"production-science-pack", 1}, {"utility-science-pack", 1}, {"space-science-pack", 1}, {"electromagnetic-science-pack", 1}}
    data.raw["technology"]["tech-electric-trains-experimental-charging"].unit.count = 2000
    -- Remove the old science prerequisites.
    data.raw["technology"]["tech-electric-trains-experimental-charging"].prerequisites = {}
    -- Add the new science prerequisites.
    data.raw["technology"]["tech-electric-trains-experimental-charging"].prerequisites = {"tech-alkaline-battery-pack", "tech-electric-trains", "tech-electric-locomotive-wagon"}

    -- Update the tech-electric-locomotive-wagon technology.
    -- Empty the ingredients table.
    data.raw["technology"]["tech-electric-locomotive-wagon"].unit.ingredients = {}
    data.raw["technology"]["tech-electric-locomotive-wagon"].unit.ingredients = {{"automation-science-pack", 1}, {"logistic-science-pack", 1}, {"chemical-science-pack", 1}, {"production-science-pack", 1}, {"utility-science-pack", 1}, {"space-science-pack", 1}, {"electromagnetic-science-pack", 1}}
    data.raw["technology"]["tech-electric-locomotive-wagon"].unit.count = 2000
    -- Remove the old science prerequisites.
    data.raw["technology"]["tech-electric-locomotive-wagon"].prerequisites = {}
    -- Add the new science prerequisites.
    ...
    -- Empty the ingredients table.
    data.raw["technology"]["tech-speed-battery-pack"].unit.ingredients = {}
    data.raw["technology"]["tech-speed-battery-pack"].unit.ingredients = {{"automation-science-pack", 1}, {"logistic-science-pack", 1}, {"chemical-science-pack", 1}, {"production-science-pack", 1}, {"utility-science-pack", 1}, {"space-science-pack", 1}, {"electromagnetic-science-pack", 1}}
    data.raw["technology"]["tech-speed-battery-pack"].unit.count = 4000
    -- Remove the old science prerequisites.
    data.raw["technology"]["tech-speed-battery-pack"].prerequisites = {}
    -- Add the new science prerequisites.
    data.raw["technology"]["tech-speed-battery-pack"].prerequisites = {"tech-electric-trains", "tech-electric-trains-experimental-charging"}

    -- Update the tech-acceleration-battery-pack technology.
    -- Empty the ingredients table.
    data.raw["technology"]["tech-acceleration-battery-pack"].unit.ingredients = {}
    data.raw["technology"]["tech-acceleration-battery-pack"].unit.ingredients = {{"automation-science-pack", 1}, {"logistic-science-pack", 1}, {"chemical-science-pack", 1}, {"production-science-pack", 1}, {"utility-science-pack", 1}, {"space-science-pack", 1}, {"electromagnetic-science-pack", 1}}
    data.raw["technology"]["tech-acceleration-battery-pack"].unit.count = 4000
    -- Remove the old science prerequisites.
    data.raw["technology"]["tech-acceleration-battery-pack"].prerequisites = {}
    -- Add the new science prerequisites.
    data.raw["technology"]["tech-acceleration-battery-pack"].prerequisites = {"tech-electric-trains", "tech-electric-trains-experimental-charging"}

    -- Update the tech-efficiency-battery-pack technology.
    -- Empty the ingredients table.
    data.raw["technology"]["tech-efficiency-battery-pack"].unit.ingredients = {}
    data.raw["technology"]["tech-efficiency-battery-pack"].unit.ingredients = {{"automation-science-pack", 1}, {"logistic-science-pack", 1}, {"chemical-science-pack", 1}, {"production-science-pack", 1}, {"utility-science-pack", 1}, {"space-science-pack", 1}, {"electromagnetic-science-pack", 1}}
    data.raw["technology"]["tech-efficiency-battery-pack"].unit.count = 4000
    -- Remove the old science prerequisites.
    data.raw["technology"]["tech-efficiency-battery-pack"].prerequisites = {}
    -- Add the new science prerequisites.
    data.raw["technology"]["tech-efficiency-battery-pack"].prerequisites = {"tech-electric-trains", "tech-electric-trains-experimental-charging"}
